    ...
    return (
        <section className="w-full bg-brand-paper pt-10 pb-16 border-b border-brand-gray-border/50">
            <div className="max-w-[1550px] mx-auto px-4 md:px-8">
                ...
                <div className="mb-16 grid grid-cols-4 gap-2 md:grid-cols-8 md:gap-3">
                    {list.map((cat, idx) => (
                        <Link
                            ...
                            >
                                ...
                                <div className="flex min-h-[56px] flex-1 flex-col items-center justify-center p-1.5 md:min-h-[88px] md:p-2.5">
                                    <div className="relative flex h-full w-full items-center justify-center">
                                        <Image
                                            ...
                                            width={100}
                                            height={100}
                                            className="h-auto w-auto max-h-[32px] object-contain transition-transform duration-700 ease-out group-hover:scale-110 md:max-h-[52px]"
                                            unoptimized
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="px-1 pb-2 text-center md:px-2 md:pb-3">
                                    <span className="block truncate text-[8px] font-bold text-brand-navy transition-colors group-hover:text-brand-yellow-bright md:text-[11px]">
                                        {cat.name}
                                    </span>
                                </div>
                            </Link>
